    ...
    <>
      <div className="flex flex-col items-center relative justify-center min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 p-4 relative overflow-hidden">
        ...
        />
          ...
          <div className="bg-black absolute opacity-30  w-full h-full"></div>
        {!startTyping && (
          <div
        ...
        {startTyping && (
          <div className="flex flex-col items-center">
            {/* Name typing */}
            <h1 className="font-bold text-white/80 text-center tracking-wider animate-slide-up-fade pb-4">
              <span className="text-6xl md:text-[8rem]">{getNameContent()}</span>
            </h1>

            {/* Job title typing */}
            {typedJobTitle && (
              <h2 className="font-bold text-white/80 text-center tracking-wider animate-slide-up-fade">
