    ...
    <div className="w-full bg-slate-900 relative z-50">
      <nav className="flex justify-between items-center py-6 px-8 bg-slate-900 border-b border-teal-400/10">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link to="about" className="!text-white/90 hover:!text-teal-400 transition-colors text-sm">About</Link>
          <Link to="#experience" className="!text-white/90 hover:!text-teal-400 transition-colors text-sm">Experience</Link>
          <Link to="#work" className="!text-white/90 hover:!text-teal-400 transition-colors text-sm">Work</Link>
          <Link to="#contact" className="!text-white/90 hover:!text-teal-400 transition-colors text-sm">Contact</Link>
      ...
      >
        <Link to="#about" onClick={toggleMenu} className="!text-white/90 hover:!text-teal-400 transition-colors text-sm">About</Link>
        <Link to="#experience" onClick={toggleMenu} className="!text-white/90 hover:!text-teal-400 transition-colors text-sm">Experience</Link>
        <Link to="#work" onClick={toggleMenu} className="!text-white/90 hover:!text-teal-400 transition-colors text-sm">Work</Link>
        <Link to="#contact" onClick={toggleMenu} className="!text-white/90 hover:!text-teal-400 transition-colors text-sm">Contact</Link>
        <Button
          variant="outline"
